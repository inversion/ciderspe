...
public class AdminTools
{
    ...
    void checkConfigFields()
    {
        ...
        if ((txtHost.getText().length() > 0)
                && (txtServiceName.getText().length() > 0)
                && (txtPort.getText().length() > 0)
                && (txtChatName.getText().length() > 0)
                && (txtBotName.getText().length() > 0)
                && (new String(txtBotPass.getPassword()).length() > 0)
                && (txtCheckName.getText().length() > 0)
                && (new String(txtCheckPass.getPassword()).length() > 0)
                && (txtSourceDir.getText().length() > 0)
                && (txtProfileDir.getText().length() > 0)
                && (txtChatHistDir.getText().length() > 0))
        {
            CreateConfig(txtHost.getText(), txtServiceName.getText(), txtPort
                    .getText(), txtChatName.getText(), txtBotName.getText(),
                    new String(txtBotPass.getPassword()), txtCheckName
                            .getText(), new String(txtCheckPass.getPassword()),
    ...
    void checkProfFields()
    {
        ...
        if ((txtName.getText().length() > 0)
                && (new String(txtPass.getPassword()).length() > 0))
        {
    ...
    void CreateConfig(String txtHost, String txtServiceName, String txtPort,
            String txtChatName, String txtBotName, String txtBotPass,
            String txtCheckName, String txtCheckPass, String txtSourceDir,
            String txtProfileDir, String txtChatHistDir)
    {
    ...
    void CreateProfile(String txtName, String txtPass)
    {
        ...
        try
        {
            ...
            out3
                    .write(txtName
                            + " chars: 0 timespent: 0  idletime: 0 lastonline: Never! colour: 150 150 150 fontSize: 14");
            out3.close();
            FileWriter fstream4 = new FileWriter(currentDir
                    + "LoginProfile.txt");
    ...
    public void displayAdTools()
    {
        ...
        GroupLayout.ParallelGroup leftColumn = ConfigLayout
                .createParallelGroup();
        ...
        GroupLayout.ParallelGroup rColumn = ProfileLayout.createParallelGroup();
