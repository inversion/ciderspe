...
tabbedPane.addTab("Tab 2", textArea);
tabbedPane.setMnemonicAt(1, KeyEvent.VK_2);

//JComponent panel3 = makeTextPanel("Panel #3");
tabbedPane.addTab("Tab 3", textArea);
tabbedPane.setMnemonicAt(2, KeyEvent.VK_3);

//JComponent panel4 = makeTextPanel(        "Panel #4 (has a preferred size of 410 x 50).");
//panel4.setPreferredSize(new Dimension(410, 50));
tabbedPane.addTab("Tab 4", textArea);
tabbedPane.setMnemonicAt(3, KeyEvent.VK_4);*/
        ...
        DefaultMutableTreeNode top = new DefaultMutableTreeNode("Some root folder");
        createNodes(top);
        ...
        splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, scrollpane/*label*/,  tabbedPane);//textArea/*label2*/);
        JSplitPane splitPane2;
        splitPane2 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, splitPane, label3);
    ...
    public void createNodes(DefaultMutableTreeNode top)
    {
        ...
        sub = new DefaultMutableTreeNode("SubFile 1");
        book.add(sub);*/
    ...
    public class Error
    {
        public void errorMessage(String message, String title)
        {
           ...
           //JOptionPane.showMessageDialog(w, "OMG you broken somethings.", "You fail", JOptionPane.ERROR_MESSAGE);
        }
    }
}
